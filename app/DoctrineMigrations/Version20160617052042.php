...
class Version20160617052042 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE song (id INT AUTO_INCREMENT NOT NULL, genre_id INT DEFAULT NULL, signer_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, year INT NOT NULL, INDEX IDX_33EDEEA14296D31F (genre_id), INDEX IDX_33EDEEA19588C067 (signer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE song ADD CONSTRAINT FK_33EDEEA19588C067 FOREIGN KEY (signer_id) REFERENCES singer (id)');
    }
